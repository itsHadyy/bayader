...
$(document).ready(function () {
    ...
    // $("#productsContainer02").css({'display': 'none'}, 0);
    $("#productsContainer02").fadeOut();
    $("#moreProd").click(function(){
        var x=$("#productsContainer02");
        if(!x.is(":visible")){
            x.show(600);
            $(this).text("Less Products");
        }else{
            x.hide(600);
            $(this).text("More Products");
        };
    });
});